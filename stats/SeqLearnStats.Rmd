...
suffix2 = '20181205_2002-LundfMRIpilot0db'
...
trialsfile = paste0('../data/trialsfile-lup0s001_fmri.csv')
trials.table = read.table(trialsfile, sep =';', header = T, quote = "")
paced_trials = subset(trials.table, paced == 1)
           
diff.1 = apply(paced_trials[c("clock_fixation", "clock_execution", "clock_feedback")], 2, diff)           
diff.2 = apply(paced_trials[c("clock_fixation", "clock_execution", "clock_feedback")], 1, diff) 
print(diff.1)
print(diff.2)

...
sel.clus = which(clusters.table > 8 )# at least 6 different sequences needed
...
#chosen_indices = which(myfinger_distance == min(myfinger_distance[mychord_distance==max(mychord_distance)]) & mychord_distance==max(mychord_distance))
...
#lapply(chosen_schedules, function(x) x$trained)

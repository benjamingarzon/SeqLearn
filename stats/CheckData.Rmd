...
test_sessions = c(0, 6, 12, 18, 24)

theme_lh <- function () { 
    theme_bw(base_size=18, base_family="Avenir")
}

trialsfile = paste0('../data/trials_table-20190527_2219-Lund1db.csv')
trialsfilefmri = paste0('../data/trials_table-20190527_2226-Lund1fmridb.csv')
...
#trials.table[trials.table$username == "lue1101" & trials.table$sess_num == 1 ]$sess_num = trials.table[trials.table$username == "lue1101", ]$sess_num - 1
...
interrupted_times.fmri = ntrials$date_time[ntrials.fmri$n < max(ntrials.fmri$n)]

print("Interrupted fmri runs")
print(interrupted_times.fmri)
trials.table.fmri = subset(trials.table.fmri, !date_time %in% interrupted_times)

trials.table.fmri = subset(trials.table.fmri, !(sess_time == "10:42:34.981000" & username == "lue1203" & sess_num == 6 ))
trials.table.fmri = subset(trials.table.fmri, !(sess_time == "11:02:27" & username == "lue1205" & sess_num == 0))
```

...
trialsfile = paste0('../data/archive/trials_table-20190316_1422-Lundpilot2db.csv')
...
# analyze only these
group = c("lup2s001")#, "lup2s002", "lup2s003", "lup2s004", "lup2s005", "lup2s006", "lup2s007", "lup2s008", "lup2s009")
...
last_trials = subset(ok_unpaced_trials, trial > 5) %>% 
